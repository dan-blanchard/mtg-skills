...
@dataclass(frozen=True)
class T_filter__OpponentDealtCombatDamage(TypedMirrorNode):
    _tag: ClassVar[str | None] = "OpponentDealtCombatDamage"
...
@dataclass(frozen=True)
class T_properties__IsChosenLandOrNonlandKind(TypedMirrorNode):
    _tag: ClassVar[str | None] = "IsChosenLandOrNonlandKind"
...
@dataclass(frozen=True)
class T_tally_mode__Threshold(TypedMirrorNode):
    _tag: ClassVar[str | None] = "Threshold"
...
type U_Foretell = T_Foretell__Cost
...
type U_Miracle = T_Miracle__Cost
...
type U_additional_filter = (
    T_additional_filter__Cmc | T_additional_filter__IsChosenCreatureType
)
...
type U_alt_ability_cost = T_alt_ability_cost__Discard | T_alt_ability_cost__PayLife
...
type U_exclude = T_exclude__ParentObjectTargetController
...
type U_filter = (
    ...
    | T_filter__OpponentDealtCombatDamage
...
type U_matched_disposition = T_matched_disposition__ChooseAnyNumber
...
type U_prop = T_prop__AttackedThisTurn | T_prop__EnteredThisTurn | T_prop__SameName
type U_properties = (
    ...
    | T_properties__IsChosenLandOrNonlandKind
...
type U_tally_mode = T_tally_mode__PerVote | T_tally_mode__Threshold
type U_target = (
...
GENERATED_BY_KEY: dict[tuple[str, str], type[TypedMirrorNode]] = {
    ...
    ("filter", "OpponentDealtCombatDamage"): T_filter__OpponentDealtCombatDamage,
    ...
    ("tally_mode", "Threshold"): T_tally_mode__Threshold,
