...
from mtg_utils._card_ir.mirror.generated.g01_root import (
    ...
    S_EntersWithCounters,
    S_ExileCastPermission,
    S_GraveyardCastPermission,
    S_ImmediatePriorSelectedCardOwner,
    S_Impending,
...
from mtg_utils._card_ir.mirror.generated.g02_modifyactivationlimi import (
    ...
    T_activation_source_filter__SelfRef,
...
from mtg_utils._card_ir.mirror.generated.g08_else_ability import (
    ...
    T_graveyard_replacement__Exile,
...
from mtg_utils._card_ir.mirror.generated.g09_keeper_constraint import (
    ...
    T_library_shuffle__TerminalShuffle,
    T_life_payment__Fixed,
    T_mana_ability_produced__SourceChosenColor,
    T_mana_cost__Cost,
    T_mana_cost__NoCost,
...
from mtg_utils._card_ir.mirror.generated.g12_qty import (
    ...
    T_redirect_lifetime__Continuous,
    T_redirect_object_filter__Any,
    T_redirect_object_filter__Typed,
    T_redirect_target__AttachedTo,
...
from mtg_utils._card_ir.mirror.generated.g14_sub_ability import (
    ...
    T_trigger_source_filter__Typed,
    T_unless_filter__Or,
...
GENERATED_BY_KEY: dict[tuple[str, str], type[TypedMirrorNode]] = {
    ...
    ("Gift", "ExtraTurn"): T_Gift__ExtraTurn,
    ...
    ("Ward", "GetPlayerCounters"): T_Ward__GetPlayerCounters,
    ...
    ("activation_source_filter", "SelfRef"): T_activation_source_filter__SelfRef,
    ...
    ("additional_cost", "Cost"): T_additional_cost__Cost,
    ...
    ("additional_filter", "SharesQuality"): T_additional_filter__SharesQuality,
    ...
    ("affected", "EventTarget"): T_affected__EventTarget,
    ...
    ("affected_players", "SourceController"): T_affected_players__SourceController,
    ...
    ("attacker", "EventSource"): T_attacker__EventSource,
    ("attacker", "Source"): T_attacker__Source,
    ...
    ("casting_restrictions", "SpendOnlyOnX"): T_casting_restrictions__SpendOnlyOnX,
    ...
    ("condition", "ChoseOtherRingBearer"): T_condition__ChoseOtherRingBearer,
    ("condition", "ChoseRingBearer"): T_condition__ChoseRingBearer,
    ...
    ("condition", "HasEnduringStory"): T_condition__HasEnduringStory,
    ("condition", "HasMaxSpeed"): T_condition__HasMaxSpeed,
    ("condition", "HasObjectTarget"): T_condition__HasObjectTarget,
    ("condition", "IfControlsMatching"): T_condition__IfControlsMatching,
    ("condition", "IsDuringUpkeep"): T_condition__IsDuringUpkeep,
    ("condition", "IsInitiative"): T_condition__IsInitiative,
    ("condition", "IsMonarch"): T_condition__IsMonarch,
    ("condition", "IsOpponentsTurn"): T_condition__IsOpponentsTurn,
    ...
    ("condition", "SourceAttackedThisCombat"): T_condition__SourceAttackedThisCombat,
    ...
    ("condition", "TurnUpCostSourcePaid"): T_condition__TurnUpCostSourcePaid,
    (
        "condition",
    ...
    ("conditions", "HasEnduringStory"): T_conditions__HasEnduringStory,
    ("conditions", "HasObjectTarget"): T_conditions__HasObjectTarget,
    ("conditions", "IsDuringUpkeep"): T_conditions__IsDuringUpkeep,
    ("conditions", "IsOpponentsTurn"): T_conditions__IsOpponentsTurn,
    ...
    ("conditions", "WhenYouDo"): T_conditions__WhenYouDo,
    (
        "conditions",
        "ZoneChangeObjectMatchesFilter",
    ): T_conditions__ZoneChangeObjectMatchesFilter,
    ...
    ("cost", "SelfManaValue"): T_cost__SelfManaValue,
    ...
    ("count_source", "Typed"): T_count_source__Typed,
    ...
    ("damage_modification", "PreventionMinus"): T_damage_modification__PreventionMinus,
    (
        "damage_modification",
        "SetToSourcePower",
    ): T_damage_modification__SetToSourcePower,
    ...
    ("damage_source_filter", "TrackedSet"): T_damage_source_filter__TrackedSet,
    ...
    ("defender", "Matching"): T_defender__Matching,
    ...
    ("die_ignore_rule", "Lowest"): T_die_ignore_rule__Lowest,
    ...
    ("domain", "OnTarget"): T_domain__OnTarget,
    ("domain", "Printed"): T_domain__Printed,
    ...
    ("dynamic_count", "DistinctColorsAmong"): T_dynamic_count__DistinctColorsAmong,
    (
        "dynamic_count",
    ...
    ("dynamic_count", "PropertyAggregate"): T_dynamic_count__PropertyAggregate,
    ...
    ("effect", "ChoosePermanent"): T_effect__ChoosePermanent,
    ...
    ("effect", "EmpowerJace"): T_effect__EmpowerJace,
    ...
    ("effect", "FlipPermanent"): T_effect__FlipPermanent,
    ...
    ("effect", "NoteManaSpent"): T_effect__NoteManaSpent,
    ("effect", "OpenAttractions"): T_effect__OpenAttractions,
    ("effect", "OpenBoosterPack"): T_effect__OpenBoosterPack,
    ...
    ("effect", "ReproduceEventCounters"): T_effect__ReproduceEventCounters,
    ("effect", "ReturnAsAura"): T_effect__ReturnAsAura,
    ("effect", "Reveal"): T_effect__Reveal,
    ("effect", "RevealChosenNumbers"): T_effect__RevealChosenNumbers,
    ...
    ("end_cost", "Cost"): T_end_cost__Cost,
    ...
    ("expiry", "UntilHostLeavesPlay"): T_expiry__UntilHostLeavesPlay,
    ...
    ("filter", "ChosenCard"): T_filter__ChosenCard,
    ...
    ("filter", "LastZoneChanged"): T_filter__LastZoneChanged,
    ...
    ("filter", "TrackedSetFiltered"): T_filter__TrackedSetFiltered,
    ("filter", "TrackedSetPossessor"): T_filter__TrackedSetPossessor,
    ("filter", "Typed"): T_filter__Typed,
    ("filters", "And"): T_filters__And,
    ("filters", "Any"): T_filters__Any,
    ("filters", "AttachedTo"): T_filters__AttachedTo,
    ("filters", "ChosenCard"): T_filters__ChosenCard,
    ...
    ("filters", "PlayerMatching"): T_filters__PlayerMatching,
    ("filters", "SelfRef"): T_filters__SelfRef,
    ("filters", "SpecificObject"): T_filters__SpecificObject,
    ...
    ("graveyard_replacement", "Exile"): T_graveyard_replacement__Exile,
    ("host", "TriggeringSource"): T_host__TriggeringSource,
    ("host", "Typed"): T_host__Typed,
    ("inner", "AbilityUseCountThisTurn"): T_inner__AbilityUseCountThisTurn,
    ("inner", "AdditionalCostPaid"): T_inner__AdditionalCostPaid,
    ...
    ("journal", "SpellsCast"): T_journal__SpellsCast,
    ...
    ("kept_destination_if", "Typed"): T_kept_destination_if__Typed,
    ("keyword", "Equip"): T_keyword__Equip,
    ("kind", "Card"): T_kind__Card,
    ("kind", "ExtraTurn"): T_kind__ExtraTurn,
    ...
    ("library_shuffle", "TerminalShuffle"): T_library_shuffle__TerminalShuffle,
    ...
    ("max", "Difference"): T_max__Difference,
    ...
    ("metric", "OfColor"): T_metric__OfColor,
    ...
    ("modifications", "CopyChosen"): T_modifications__CopyChosen,
    ...
    ("modifications", "GrantReplacement"): T_modifications__GrantReplacement,
    ...
    ("optional_player", "DefendingPlayer"): T_optional_player__DefendingPlayer,
    (
        "optional_player",
        "ParentTargetController",
    ): T_optional_player__ParentTargetController,
    ("optional_player", "ScopedPlayer"): T_optional_player__ScopedPlayer,
    ("optional_player", "TriggeringPlayer"): T_optional_player__TriggeringPlayer,
    ...
    ("owner", "AttachedTo"): T_owner__AttachedTo,
    ...
    ("payer", "DefendingPlayer"): T_payer__DefendingPlayer,
    ("payer", "EventTargetController"): T_payer__EventTargetController,
    ...
    ("player", "ControlsCount"): T_player__ControlsCount,
    ...
    ("player", "OpponentOfTriggeringPlayer"): T_player__OpponentOfTriggeringPlayer,
    ...
    ("player", "PlayerAttribute"): T_player__PlayerAttribute,
    ...
    ("player_filter", "Controller"): T_player_filter__Controller,
    ("player_filter", "Opponent"): T_player_filter__Opponent,
    (
        "player_filter",
        "OpponentOtherThanTriggering",
    ): T_player_filter__OpponentOtherThanTriggering,
    ("player_filter", "PlayerAttribute"): T_player_filter__PlayerAttribute,
    ...
    ("player_scope", "TrackedSetPossessor"): T_player_scope__TrackedSetPossessor,
    ("player_scope", "TriggeringPlayer"): T_player_scope__TriggeringPlayer,
    ("player_scope", "VotedFor"): T_player_scope__VotedFor,
    ("players", "All"): T_players__All,
    ("players", "Controller"): T_players__Controller,
    ...
    ("prop", "ZoneChangedThisTurn"): T_prop__ZoneChangedThisTurn,
    ("properties", "Another"): T_properties__Another,
    ("properties", "AnyOf"): T_properties__AnyOf,
    ("properties", "AttachedToPlayer"): T_properties__AttachedToPlayer,
    ...
    ("properties", "SameNameAsExiledBySource"): T_properties__SameNameAsExiledBySource,
    ...
    ("qty", "BasePower"): T_qty__BasePower,
    ...
    ("qty", "DistinctColorsAmong"): T_qty__DistinctColorsAmong,
    ...
    ("qty", "PlayerChosenNumber"): T_qty__PlayerChosenNumber,
    ...
    ("qty", "PreviousEffectCount"): T_qty__PreviousEffectCount,
    ("qty", "PropertyAggregate"): T_qty__PropertyAggregate,
    ("qty", "SacrificedThisTurn"): T_qty__SacrificedThisTurn,
    ("qty", "SelfManaValue"): T_qty__SelfManaValue,
    ("qty", "Speed"): T_qty__Speed,
    ("qty", "SpellsCastBeforeTriggeringSpell"): T_qty__SpellsCastBeforeTriggeringSpell,
    ...
    ("qty", "TriggeringScryBottomCount"): T_qty__TriggeringScryBottomCount,
    ("qty", "TriggeringScryLookCount"): T_qty__TriggeringScryLookCount,
    ...
    ("recipient", "All"): T_recipient__All,
    ("recipient", "Controller"): T_recipient__Controller,
    ("recipient", "DefendingPlayer"): T_recipient__DefendingPlayer,
    ("recipient", "EachController"): T_recipient__EachController,
    ("recipient", "Neighbor"): T_recipient__Neighbor,
    ("recipient", "OtherBatchSource"): T_recipient__OtherBatchSource,
    ...
    ("recipient", "PlayerMatching"): T_recipient__PlayerMatching,
    ...
    ("recipient", "Target"): T_recipient__Target,
    ...
    ("recipient", "Untargeted"): T_recipient__Untargeted,
    ...
    ("redirect_lifetime", "Continuous"): T_redirect_lifetime__Continuous,
    ("redirect_object_filter", "Any"): T_redirect_object_filter__Any,
    ("redirect_object_filter", "Typed"): T_redirect_object_filter__Typed,
    ("redirect_target", "AttachedTo"): T_redirect_target__AttachedTo,
    ("redirect_target", "SelfRef"): T_redirect_target__SelfRef,
    ("redirect_to", "AttachedToSource"): T_redirect_to__AttachedToSource,
    ("redirect_to", "ChosenTarget"): T_redirect_to__ChosenTarget,
    ("redirect_to", "Controller"): T_redirect_to__Controller,
    ("redirect_to", "DamageSourceController"): T_redirect_to__DamageSourceController,
    ("redirect_to", "SourceObject"): T_redirect_to__SourceObject,
    ("reference", "CostPaidObject"): T_reference__CostPaidObject,
    ("reference", "EventTarget"): T_reference__EventTarget,
    ...
    ("required_defender", "Controller"): T_required_defender__Controller,
    ("required_defender", "SelfRef"): T_required_defender__SelfRef,
    ("required_defender", "Typed"): T_required_defender__Typed,
    (
        "restriction",
    ...
    ("scope", "BatchSource"): T_scope__BatchSource,
    ("scope", "ChainRootTarget"): T_scope__ChainRootTarget,
    ...
    ("source", "TurnJournal"): T_source__TurnJournal,
    ...
    ("source_filters", "Typed"): T_source_filters__Typed,
    ...
    ("sources", "Objects"): T_sources__Objects,
    ("sources", "ParentTarget"): T_sources__ParentTarget,
    ("sources", "TurnJournal"): T_sources__TurnJournal,
    ...
    ("target", "AmassedArmy"): T_target__AmassedArmy,
    ...
    ("target", "EventTargetController"): T_target__EventTargetController,
    ...
    ("target", "LastRevealed"): T_target__LastRevealed,
    ("target", "LastZoneChanged"): T_target__LastZoneChanged,
    ...
    ("target", "SourceController"): T_target__SourceController,
    ...
    ("target_player", "ParentTarget"): T_target_player__ParentTarget,
    (
        "target_player",
        "ParentTargetController",
    ): T_target_player__ParentTargetController,
    ("target_player", "Player"): T_target_player__Player,
    ("target_player", "ScopedPlayer"): T_target_player__ScopedPlayer,
    ...
    ("trigger_source_filter", "Typed"): T_trigger_source_filter__Typed,
    ...
    ("valid_card", "ChosenCard"): T_valid_card__ChosenCard,
    ...
    ("valid_source", "Controller"): T_valid_source__Controller,
    ...
    ("valid_target", "Opponent"): T_valid_target__Opponent,
    ...
    ("valid_target", "PlayerMatching"): T_valid_target__PlayerMatching,
...
GENERATED_BY_CKEY: dict[str, type[TypedMirrorNode]] = {
    "<root>": S_Root,
    "ActivateAsInstant": S_ActivateAsInstant,
    ...
    "CantCauseForcedAction": S_CantCauseForcedAction,
    ...
    "EntersWithCounters": S_EntersWithCounters,
    "ExileCastPermission": S_ExileCastPermission,
    "GraveyardCastPermission": S_GraveyardCastPermission,
    "ImmediatePriorSelectedCardOwner": S_ImmediatePriorSelectedCardOwner,
    ...
    "at_resolution": S_at_resolution,
    "bounds": S_bounds,
    "bracket_signals": S_bracket_signals,
    "branches": S_branches,
    "card_type": S_card_type,
    "cards": S_cards,
    "cast_cost_modifier": S_cast_cost_modifier,
    ...
    "filter": S_filter,
    "gap": S_gap,
    "keeper_counter": S_keeper_counter,
    ...
    "target": S_target,
    "target_condition": S_target_condition,
    "trigger": S_trigger,
    "triggers": S_triggers,
