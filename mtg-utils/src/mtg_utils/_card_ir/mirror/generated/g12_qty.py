...
@dataclass(frozen=True)
class T_qty__BasePower(TypedMirrorNode):
    _tag: ClassVar[str | None] = "BasePower"
    scope: U_scope
...
@dataclass(frozen=True)
class T_qty__DistinctColorsAmong(TypedMirrorNode):
...
@dataclass(frozen=True)
class T_qty__PlayerChosenNumber(TypedMirrorNode):
...
@dataclass(frozen=True)
class T_qty__PreviousEffectCount(TypedMirrorNode):
    _tag: ClassVar[str | None] = "PreviousEffectCount"


@dataclass(frozen=True)
class T_qty__PropertyAggregate(TypedMirrorNode):
...
@dataclass(frozen=True)
class T_qty__SpellsCastBeforeTriggeringSpell(TypedMirrorNode):
    _tag: ClassVar[str | None] = "SpellsCastBeforeTriggeringSpell"
    filter: U_filter
    scope: str
...
@dataclass(frozen=True)
class T_recipient__DefendingPlayer(TypedMirrorNode):
...
@dataclass(frozen=True)
class T_redirect_target__AttachedTo(TypedMirrorNode):
    _tag: ClassVar[str | None] = "AttachedTo"
...
type U_qty = (
    ...
    | T_qty__PlayerChosenNumber
    | T_qty__PlayerCount
    | T_qty__PlayerCounter
    | T_qty__Power
    | T_qty__PreviousEffectAmount
    | T_qty__PreviousEffectCount
    | T_qty__PropertyAggregate
    | T_qty__SacrificedThisTurn
    | T_qty__SelfManaValue
    | T_qty__Speed
    | T_qty__SpellsCastBeforeTriggeringSpell
