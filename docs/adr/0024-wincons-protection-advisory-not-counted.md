...
emerges that settles the fork, revisit it *here* — don't silently encode a number. Don't
read the tuner's ADR-0030 bracket-constraint gate (Game Changers / mass land denial /
